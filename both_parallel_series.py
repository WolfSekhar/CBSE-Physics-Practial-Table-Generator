...
class BothParallelAndSries:
    ...
    def run(self):
        print("To verify the law of combination (parallel and Series) \n of resistance using a meter bridge)")
        print("---------------------------------------------------")
        ...
        for i in range(2):
            if i == 0:
                ...
                global rev_values
                del rev_values
                parallel_combination_value = calculate_combination_series_from_r1_r2()
                print("----------------------------------")
                parallel_value = round(parallel_combination_value + 0.01, 2)
            ...
            if i == 0:
                ...
                print("series comb value : ", round(parallel_combination_value, 2))
            print("//////////////////////////////")


both = BothParallelAndSries()
both.run()
